  ...
  return (
    <div className={clsx('card flex flex-col overflow-hidden', className)}>
      ...
      {pageSize > 0 && totalPages > 1 && (
        <div className="flex items-center justify-between px-3 py-2 border-t border-surface-border text-xs text-text-muted">
          <span>
          ...
          <div className="flex items-center gap-1">
            <button
              ...
              className="p-1 rounded-sm hover:bg-surface-active disabled:opacity-40 disabled:cursor-not-allowed transition-colors"
