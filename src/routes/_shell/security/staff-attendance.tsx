...
import { api } from '../../../api'
import { StaffAttendance } from '../../../api'
...
const columnHelper = createColumnHelper<StaffAttendance>()
...
function StaffAttendancePage() {
  ...
  const { data, isLoading } = useQuery({
    ...
    queryFn: api.staffAttendance.list,
  })

  const mutation = useMutation({
    mutationFn: api.staffAttendance.create,
    onSuccess: () => {
  ...
  return (
    <div className="space-y-4">
      <div className="flex justify-between items-center">
        <h2 className="text-xl font-bold font-header tracking-tight text-primary">Staff Attendance</h2>
        <button
      ...
      <Modal isOpen={isModalOpen} onClose={() => setIsModalOpen(false)} title="Add Staff Attendance">
